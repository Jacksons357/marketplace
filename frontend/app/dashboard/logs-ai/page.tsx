...
import { useLogAi } from "@/lib/mutations/log";
...
export default function LogsAiPage() {
  ...
  const { mutateAsync: fetchLogs, isPending } = useLogAi();
  ...
  return (
    <div className="p-6 space-y-8">
      <h1 className="text-2xl font-semibold">Consultar Logs de IA</h1>
              ...
              <TableBody>
                {paginatedLogs.map((log) => (
                  <TableRow key={log.id}>
                    ...
                    <TableCell className="text-xs text-muted-foreground max-w-[400px] whitespace-pre-wrap">
                      {log.filters
